export function renderWhatsAppButton() {
  ...
  container.innerHTML = `
    <a href="https://wa.me/918660627567?text=Hello,%20I%20am%20interested%20in%20your%20financial%20services." 
       target="_blank" 
       class="fixed bottom-6 right-6 z-[9999] bg-[#25D366] text-white p-4 rounded-full shadow-[0_10px_30px_rgba(37,211,102,0.4)] transition-smooth transform hover:scale-110 flex items-center justify-center group"
      ...
      <span class="absolute right-full mr-4 bg-white text-gray-800 px-4 py-2 rounded-lg text-sm font-bold shadow-xl whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none border border-gray-100">
        Hi! How can we help?
      </span>
    </a>
  `;
