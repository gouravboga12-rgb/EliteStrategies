    ...
    <div class="container mx-auto px-6 md:px-12 relative z-10">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div data-aos="fade-right">
          <h2 class="text-primary-light font-bold tracking-widest uppercase text-sm mb-4">Why Partner With Us?</h2>
          <h3 class="text-3xl md:text-5xl font-bold text-white mb-8">Committed to Excellence in Financial Services</h3>
          <p class="text-secondary opacity-90 mb-12 text-lg leading-relaxed">
            ...
            ${reasons.map((reason, index) => `
              <div class="flex items-start space-x-4" data-aos="fade-up" data-aos-delay="${index * 100}">
                ...
                <div>
                  ...
                  <p class="text-secondary opacity-80 text-sm">${reason.desc}</p>
                </div>
              </div>
            `).join('')}
          </div>
