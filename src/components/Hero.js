export function renderHero() {
  ...
  container.innerHTML = `
    ...
    <div class="container mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-10">
      <div data-aos="fade-right" class="text-center md:text-left flex flex-col items-center md:items-start">
        ...
        <div class="mt-12 flex flex-col items-center md:items-start space-y-4 md:space-y-0 md:flex-row md:space-x-6">
          <div class="flex -space-x-3">
            ...
            <div class="w-10 h-10 rounded-full border-2 border-white bg-primary-light shadow-sm"></div>
          </div>
